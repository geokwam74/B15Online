...
public class GroceryActions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("How many you to buy ?");
        int potatoCount = scan.nextInt();
        System.out.println("Your total for potato is " + (potatoPrice) );
        ...
        System.out.println("Your total for potato is " + bananaTotal);

        System.out.println("You got " + tomatoCount + " tomatoes, the price is " + tomatoPrice
